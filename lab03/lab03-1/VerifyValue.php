<?php
    ...
    function verifyMonth($month,$check){
        echo "<br><br>";
        if ($month==4||$month==6||$month==9||$month==11) echo "This month has 30 days";
        if ($month==1||$month==3||$month==5||$month==7||$month==8||$month==10||$month==12) echo "This month has 31 days";
        if($month==2) {
                if ($check==1) echo "This month has 29 days";
